...
import { Subscriber, ISubscriber } from '../models/Subscriber.ts'
...
static async findSubscriberByEmail(data: ISubscriber): Promise<ISubscriber | null> {
 ...
 */
static async updateSubscriber(id: string, data: ISubscriber): Promise<ISubscriber | null> {
